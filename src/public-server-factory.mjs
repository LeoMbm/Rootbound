...
export function createPublicServerFactory({ executor, authorityExecutor, publicContext, browserReader, continuityState, rescueManager, commandManager, stateStore, maxConcurrent = 1 }) {
  ...
  return function createServer(requestContext = {}) {
    ...
    registerRescueTools(server, { context: publicContext, authorityExecutor, continuityState, stateStore, rescueManager, getSessionKey });
